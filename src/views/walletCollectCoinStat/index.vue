<template>
  <div class="page-wrapper">
    ...
    <el-table :data="tableData" style="width: 100%" class="public-table" border>
      ...
      <el-table-column
        prop="walletAddress"
        label="Having collected wallet"
        align="center"
        show-overflow-tooltip
      ></el-table-column>
      <el-table-column prop="userName" label="Chain" align="center">
        <template slot-scope="scope">
          <p>{{ scope.row.userId }}</p>
          <p>{{ scope.row.userName }}</p>
        </template>
      </el-table-column>
      <el-table-column prop="chainName" label="Asset type" align="center">
      </el-table-column>
      <el-table-column prop="coin" label="quantity" align="center"> </el-table-column>
      <el-table-column prop="assetBalance" label="gas" align="center"> </el-table-column>
