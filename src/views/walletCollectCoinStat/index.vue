<template>
  <div class="page-wrapper">
    ...
    <el-table :data="tableData" style="width: 100%" class="public-table" border>
      ...
      ></el-table-column>
      <el-table-column prop="userName" label="链类型" align="center">
        <template slot-scope="scope">
          <p>{{ scope.row.userId }}</p>
          <p>{{ scope.row.userName }}</p>
        </template>
      </el-table-column>
      <el-table-column prop="chainName" label="资产类型" align="center">
      </el-table-column>
      <el-table-column prop="coin" label="数量" align="center">
      </el-table-column>
      <el-table-column prop="assetBalance" label="GAS" align="center">
      </el-table-column>
